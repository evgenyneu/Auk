...
class AukTests: XCTestCase {
  ...
  func testIsPageVisible_firstPageVisible() {
    let image1 = uiImageFromFile("96px.png")
    auk.show(image: image1)
    ...
    let aukPage1 = aukPages(scrollView)[0]
    let aukPage2 = aukPages(scrollView)[1]

    XCTAssert(auk.isPageVisible(aukPage1))
    XCTAssertFalse(auk.isPageVisible(aukPage2))
  }
  
  func testIsPageVisible_bothPagesAreVisible() {
    let image1 = uiImageFromFile("96px.png")
    auk.show(image: image1)
    ...
    XCTAssert(auk.isPageVisible(aukPage1))
    XCTAssert(auk.isPageVisible(aukPage2))
  }
  ...
  func testIsPageVisible_lastPageVisible() {
    ...
    XCTAssertFalse(auk.isPageVisible(aukPage1))
    XCTAssert(auk.isPageVisible(aukPage2))
  }
}
